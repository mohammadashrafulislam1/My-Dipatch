...
const Default = () => {
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl p-6 space-y-4 shadow">
          ...
          <div className="relative">
            <IoLocationSharp className="w-5 h-5 text-blue-600 absolute left-3 top-3.5" />
            <input
              type="text"
          ...
          {midwayStops.map((_, index) => (
            <div key={index} className="mb-3 flex items-center justify-between gap-2">
              <div className="relative w-full">
  <IoLocationSharp className="w-5 h-5 text-green-600 absolute left-3 top-3.5" />
  <input
    type="text"
    placeholder="Midway Stop"
    className="w-full border border-gray-300 rounded-md pl-10 p-3 
  ...
  />
          ...
          {/* Drop Location */}
          <div className="relative">
  <IoLocationSharp className="w-5 h-5 text-red-600 absolute left-3 top-3.5" />
  <input
    type="text"
...
<div className="relative">
  <textarea
    ...
    className="w-full border border-gray-300 rounded-md pl-3 pr-3 py-3
               focus:outline-none focus:ring-2 focus:ring-blue-500
               bg-white text-black dark:bg-white dark:text-black resize-none"
  />
</div>
